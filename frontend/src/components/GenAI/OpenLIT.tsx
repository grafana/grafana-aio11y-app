...
const OpenLIT = () => {
  return (
    <div>
        ...
        <InstallDashboard filePath='https://raw.githubusercontent.com/grafana/hackathon-2024-03-tame-the-beast/main/gtm-aiobservability-app/src/instructions/llms/openai/dashboard.json?token=GHSAT0AAAAAACKHWE6CWH7A5ORZB6XWN5E4ZUOTL6Q'/>
