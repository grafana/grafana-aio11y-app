import { grafanaAlloyPytorchServe, mlTensorflowMetricsConfig, mlTensorflowScrapeConfig } from 'pages/snippets'
  ...
  return (
    <div>
        <div style={{ marginLeft: '32px', padding: '16px' }}>
          <h1>Monitor Tensorflow Serving</h1>
          ...
          <h3>Logs</h3>
          <p>Below <code>logs.configs.scrape_configs</code>, insert the following lines according to your environment:</p>
          <pre>{mlTensorflowScrapeConfig()}</pre>
          <h3>Metrics</h3>
          <p>Below <code>metrics.configs.scrape_configs</code>, insert the following lines according to your environment:</p>
          <pre>{mlTensorflowMetricsConfig()}</pre>
